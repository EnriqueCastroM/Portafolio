      ...
      <div className='px-4 py-5 sm:px-6'>
        <div className='bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
          ...
          <dd className='mt-1 text-md text-gray-500 sm:col-span-2 sm:mt-0'>
            Hello World! I'm a motivated full-stack engineer who has +6 months of experience building and scaling web applications and services in various domains. I'm also passionate about indie videogames development, ready to work in high impact environment in a tech company, and contribute to grow development teams by helping build great products, applications and games. Thank you for share your time with me here, take a look of Portfolio and Contact sections!
          </dd>
        </div>
      </div>
      <div className='border-t border-gray-200'>
        <dl>
          ...
          <div className='bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
            ...
            <dd className='mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0'> + $1,500 USD </dd>
          </div>
